...
public class CompletedRequestsAdapter extends RecyclerView.Adapter<CompletedRequestsAdapter.CompletedRequestsViewHolder> {
        private Context mCtx;
        private List<CompletedRequests> CompletedRequestsList;
        public SessionManager session;
        View itemView;

        public CompletedRequestsAdapter(Context mCtx, List<CompletedRequests> CompletedRequestsList) {
            this.mCtx = mCtx;
        ...
        @Override
        public CompletedRequestsAdapter.CompletedRequestsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            LayoutInflater inflater = LayoutInflater.from(mCtx);
            View view = inflater.inflate(R.layout.accepted_request_list, null);
            return new CompletedRequestsAdapter.CompletedRequestsViewHolder(view);
        }

        @Override
        public void onBindViewHolder(CompletedRequestsAdapter.CompletedRequestsViewHolder holder, int position) {
        ...
        class CompletedRequestsViewHolder extends RecyclerView.ViewHolder {
            ...
            public CompletedRequestsViewHolder(View itemView) {
                super(itemView);
