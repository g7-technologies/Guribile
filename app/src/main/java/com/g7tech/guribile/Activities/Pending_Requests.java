...
import com.g7tech.guribile.HelperClasses.PendingRequestAdapter;
...
public class Pending_Requests extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        URLL = AppConfig.URL_PENDING_WORK_LIST+session.getId();
        Log.e("urlll",URLL);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if(array.length() == 0){
                                ...
                                PendingRequestAdapter adapter = new PendingRequestAdapter(Pending_Requests.this, CompletedRequestsList);
                                progressBar.setVisibility(View.INVISIBLE);
